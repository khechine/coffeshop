               ...
               <div className="flex-1.5 min-w-[320px] space-y-4">
                  ...
                  <div className="grid grid-cols-1 sm:grid-cols-3 gap-4">
                     {[
                        ...
                        <div key={i} className={`p-4 rounded-2xl border flex flex-col items-center gap-3 transition-all ${s.done ? 'bg-emerald-50 border-emerald-100 dark:bg-emerald-500/5' : 'bg-amber-50 border-amber-100 dark:bg-amber-500/5'
                           }`}>
                     ...
                     <div className="p-10 flex-1">
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                           {planDef.features.map(f => (
                              <div key={f.label} className={`flex items-center gap-3 p-4 rounded-2xl border transition-all ${f.included ? 'bg-emerald-50/50 border-emerald-100/50 dark:bg-emerald-500/5' : 'bg-slate-50/50 border-slate-100 dark:bg-slate-500/5'
                                 }`}>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="bg-white dark:bg-slate-900 border border-slate-100 dark:border-slate-800 rounded-[40px] shadow-sm overflow-hidden flex flex-col">
               ...
               <div className="p-10 flex-1 flex flex-col justify-center gap-8">
                  <div className={`p-8 rounded-[32px] border transition-all flex flex-col gap-4 text-center ${store.forceMarketplaceAccess ? 'bg-emerald-50 border-emerald-100' : 'bg-rose-50 border-rose-100'
                     }`}>
