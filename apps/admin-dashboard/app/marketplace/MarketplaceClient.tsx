...
export default function MarketplaceClient({ initialData }: { initialData: any }) {
  ...
  const cssStyles = [
    ...
    '.premium-card { transition: all 0.4s cubic-bezier(0.4, 0, 0.2, 1); border: 1px solid rgba(226, 232, 240, 0.6); border-radius: 24px; overflow: hidden; position: relative; background: #fff; box-shadow: 0 4px 6px -1px rgba(0, 0, 0, 0.02), 0 2px 4px -1px rgba(0, 0, 0, 0.01); }',
    '.premium-card:hover { transform: translateY(-10px) scale(1.01); border-color: #4F46E5; box-shadow: 0 25px 50px -12px rgba(0, 0, 0, 0.08); }',
    ...
    '.mesh-gradient { background: linear-gradient(-45deg, #1E1B4B, #4F46E5, #312E81, #4338CA); background-size: 400% 400%; animation: mesh 15s ease infinite; }',
